    ...
    return (
      <div className="App">
        <Container>
          ...
          <Row>
            ...
            <Col md={4} style={{padding: '0 2rem'}}>
              ...
              <PanelDesc> 
                ...
                A good place to start building is the <a href='http://www.conwaylife.com/wiki/Conway%27s_Game_of_Life' rel='noopener noreferrer' target='_blank' style={{color: 'inherit',textDecoration: 'none'}}><strong>Cownay's Game of Life Wikipedia pag</strong>e</a>.<br/><br/>
          ...
          <p style={{fontSize: '0.75rem', opacity: '0.5', textAlign: 'left'}}>Copyright &copy; 2018 Tsoyuzhu, All rights reserved. </p>
        </Container>
      </div>
    );
  }
